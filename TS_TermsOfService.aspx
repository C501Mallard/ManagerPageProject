<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerPage.master" AutoEventWireup="true" CodeFile="TS_TermsOfService.aspx.cs" Inherits="TermsOfService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div>
        <h3><i class="col-lg-12 fa fa-file-text fa-fw"></i>&nbsp;服務條款</h3>
        <hr />
    </div>
    <blockquote class="col-lg-12 col-md-12 col-sm-12 col-xs-12 container">

                <p>非常歡迎您光臨<b>「食品添加物查詢管理系統」</b>（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
